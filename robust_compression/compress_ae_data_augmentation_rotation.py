...
#     save_name = '../trained_no_robust2/ae_c_d{}L{}.pt'.format(latent_dim, L)
    save_name = f'../trained_robust_augmentation/ae_c_d{latent_dim}L{L}rotation_only.pt'
...
if __name__ == '__main__':
    ...
    for rho in rhos:
        ...
        train_loader = torch.utils.data.DataLoader(mnist_ood_train, batch_size=batch_size,
                                                    shuffle=True)
        ...
        sys.stdout.flush()
        train(latent_dim, L, None, train_loader, test_loader)
